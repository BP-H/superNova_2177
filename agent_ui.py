...
"""Streamlit components for agent diary and RFC insights."""
...
def render_agent_insights_tab() -> None:
    """Display virtual diary and RFC references."""
    ...
    notes_content = notes_path.read_text() if notes_path.exists() else "No notes found."
