...
async def test_explore_page_failure(monkeypatch):
    xp = pytest.importorskip("pages.explore_page")
    ...
    monkeypatch.setattr(xp.ui, "label", lambda *a, **k: Dummy(), raising=False)
    monkeypatch.setattr(xp.ui, "column", lambda *a, **k: Dummy(), raising=False)
    monkeypatch.setattr(xp.ui, "card", lambda *a, **k: Dummy(), raising=False)
    monkeypatch.setattr(xp, "skeleton_loader", lambda *a, **k: Dummy())
    monkeypatch.setattr(xp.ui, "run_javascript", lambda *a, **k: False, raising=False)
    monkeypatch.setattr(xp.ui, "timer", lambda *a, **k: None, raising=False)
    monkeypatch.setattr(xp.ui, "open", lambda *a, **k: None, raising=False)
    monkeypatch.setattr(xp.ui, "run_async", lambda coro: None, raising=False)
    ...
    monkeypatch.setattr(xp.ui, "notify", fake_notify, raising=False)
