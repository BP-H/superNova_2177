...
ENTANGLEMENT_NORMALIZATION_FACTOR = getattr(
    Config, "ENTANGLEMENT_NORMALIZATION_FACTOR", DEFAULT_ENTANGLEMENT_FACTOR * 10
)
ENTROPY_MODIFIER_SCALE = getattr(Config, "ENTROPY_MODIFIER_SCALE", 2000.0)
ENTROPY_INTERVENTION_THRESHOLD = getattr(Config, "ENTROPY_INTERVENTION_THRESHOLD", 1200.0)
ENTROPY_INTERVENTION_STEP = getattr(Config, "ENTROPY_INTERVENTION_STEP", 50.0)
ENTROPY_CHAOS_THRESHOLD = getattr(Config, "ENTROPY_CHAOS_THRESHOLD", 1500.0)
